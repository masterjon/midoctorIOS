                      ...
                      @{
                        ...
                        @"doctors":@[
                                ...
                                @{
                                    ...
                                    @"speciality":@"Pediatra",
                                    @"logo":@"logo_geny",
                                    @"images":@[@"logo_geny_big",@"seccion_geny"],
                                    @"phone":@"8482946",
                      ...
                      @{
                        ...
                        @"doctors":@[
                                @{
                                    ...
                                    @"speciality":@"Alergólogo",
                                    @"logo":@"logo_navarrete",
                                    @"images":@[@"logo_navarrete_big",@"navarrete1",@"navarrete2",@"navarrete3",@"mascota_bg_alergologo"],
                                    @"phone":@"8981927",
                                ...
                                @{
                                    ...
                                    @"speciality":@"Alergólogo",
                                    @"logo":@"logo_aurora",
                                    @"images":@[@"logo_aurora_big",@"risa",@"mascota_bg_alergologo"],
                                    @"phone":@"8981927",
                      ...
                      @{
                        ...
                        @"doctors":@[
                                @{
                                    ...
                                    @"images":@[@"logo_omar_ernesto_rojas_big",@"mascota_bg_reumatologo"],
                                    @"phone":@"8981927",
