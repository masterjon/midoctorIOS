//
//  DetalleClinicasViewController.m
//  Tu Doctor
//
...
@interface DetalleClinicasViewController ()<KIImagePagerDelegate, KIImagePagerDataSource>

@property (strong, nonatomic) IBOutlet KIImagePager *_imagePager;

@end

@implementation DetalleClinicasViewController
